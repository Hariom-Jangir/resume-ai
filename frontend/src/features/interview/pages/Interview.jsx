...
const Interview = () => {
    ...
    if (loading || !report) {
        return (
            <>
                <AppNavbar />
                <main className="loading-screen interview-page">
        ...
        <>
            ...
            <div className="interview-page">
                <div className="interview-layout">
                    ...
                    <div className="interview-mobile-bar">
                        <p className="interview-nav__label">Sections</p>
                        <div className="interview-mobile-nav">
